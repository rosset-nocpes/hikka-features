...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        'text-muted-foreground text-sm [a]:*:underline [a]:*:underline-offset-3 hover:[a]:*:text-foreground',
        className,
      )}
      {...props}
    />
