      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper flex items-center justify-center has-[[data-variant=inset]]:bg-sidebar', // Removed w-full
              className,
            )}
            ref={ref}
            {...props}
      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ? 'w-[calc(var(--sidebar-width)+1rem)] group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]'
        ...
        <div
          className={cn(
            ...
            side === 'left'
              ? variant === 'floating'
                ? 'left-0 group-data-[collapsible=offcanvas]:left-[calc((var(--sidebar-width)+1rem)*-1)]'
                : 'left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]'
              : variant === 'floating'
                ? 'right-0 group-data-[collapsible=offcanvas]:right-[calc((var(--sidebar-width)+1rem)*-1)]'
  ...
  (
    ...
    return (
      <Tooltip delayDuration={0}>
        ...
        <TooltipPortal container={tooltipContainer}>
          <TooltipContent
            side="right"
            align="center"
